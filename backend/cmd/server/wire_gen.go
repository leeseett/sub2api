...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	requestRecordRepository := repository.NewRequestRecordRepository(db)
	requestRecordService := service.NewRequestRecordService(requestRecordRepository)
	requestRecordHandler := admin.NewRequestRecordHandler(requestRecordService)
